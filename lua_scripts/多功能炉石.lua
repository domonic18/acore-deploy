...
local Menu={
	[MMENU]={--主菜单
		...
		{FUNC, "炉石|cFFF0F000→|r传回", 	Stone.GoHome,	GOSSIP_ICON_TAXI,		  false,"是否使用炉石|cFFF0F000返回旅店|r ?"},
		...
		--{FUNC, "空中邮箱", 		Stone.OpenMailBox,	GOSSIP_ICON_VENDOR},
	...
	[MMENU+0x10]={--其他功能
		--{FUNC, "重置副本",	Stone.UnBind,	GOSSIP_ICON_TRAINER,	false,"确认重置所有副本进度?",50000000},
	...
	[TPMENU+0x50]={--外域
	    {TP, "地狱火半岛",		530,	-207.335,	2035.92,	96.464,		1.59676,	TEAM_NONE},
	...
	[ENCMENU+0x100] = {-- 主手1
		{ENC, "攻强+110", 3827, EQUIPMENT_SLOT_MAINHAND			, 0 , "是否对主手装备附魔？" , 1000000 },
		{ENC, "法强+81", 3854, EQUIPMENT_SLOT_MAINHAND			, 0 , "是否对主手装备附魔？" , 1000000 },
		{ENC, "命中+25，爆击+25", 3788, EQUIPMENT_SLOT_MAINHAND , 0 , "是否对主手装备附魔？" , 1000000 },
		{ENC, "破冰武器",  3239, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 1000000 },
		{ENC, "邪恶武器",  1899, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 1000000 },
		{ENC, "死亡霜冻",  3273, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 1000000 },
		{ENC, "作战专家",  2675, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 1000000 },
		{ENC, "生命偷取",  1898, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 1000000 },
		{ENC, "生命护卫",  3241, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 1000000 },
		{ENC, "巨人杀手",  3251, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 1000000 },
		{ENC, "屠魔"    ,   912, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 1000000 },	
		{MENU, "下一页", ENCMENU+0x1100,GOSSIP_ICON_BATTLE},
	},
	[ENCMENU+0x1100]={-- 主手2
		{ENC, "狂暴"    ,  3789, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 800000 },
		{ENC, "斩杀"    ,  3225, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 800000 },
		{ENC, "猫鼬"    ,  2673, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 800000 },
		{ENC, "黑魔法"  ,  3790, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 800000 },
		{ENC, "精金神铁武器链", 3223, EQUIPMENT_SLOT_MAINHAND	, 0 , "是否对主手装备附魔？" , 800000 },--缴械时间-50%,招架+15
		{ENC, "泰坦神铁武器链", 3731, EQUIPMENT_SLOT_MAINHAND	, 0 , "是否对主手装备附魔？" , 800000 },--缴械时间-50%,命中+28
		{ENC, "毒皮毒药",  1003, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 800000 },
		{ENC, "速效药膏",  3769, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 800000 },
		{ENC, "致命药膏",  3771, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 800000 },
		{ENC, "致伤药膏",  3773, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 800000 },
		{ENC, "麻醉药膏",  3774, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 800000 },
		{MENU, "下一页", ENCMENU+0x2100,GOSSIP_ICON_BATTLE},
	},		
	[ENCMENU+0x2100]={-- 主手3
		{ENC, "火舌武器",  3781, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 500000 },
		{ENC, "冰封武器",  3784, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 500000 },
		{ENC, "风怒武器",  3787, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 500000 },
		{ENC, "灼热武器",   803, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 500000 },
		{ENC, "冰冷武器",  1894, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 500000 },
		{ENC, "吸血 [75级]",  3870, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 500000 },
		{ENC, "利刃防护 [75级]", 3869, EQUIPMENT_SLOT_MAINHAND	, 0 , "是否对主手装备附魔？" , 500000 },
		{ENC, "火焰石"  ,  3614, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 500000 },
		{ENC, "法术石"  ,  3620, EQUIPMENT_SLOT_MAINHAND		, 0 , "是否对主手装备附魔？" , 500000 },
		{ENC, "暗影之油", 25, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对主手装备附魔？" , 500000 },
		{ENC, "冰霜之油", 26, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对主手装备附魔？" , 500000 },
		{ENC, "冰霜符文武器",  3322, EQUIPMENT_SLOT_MAINHAND	, 0 , "是否对主手装备附魔？" , 500000 },
		{ENC, "清除主手武器附魔",-1,EQUIPMENT_SLOT_MAINHAND},
	},
	[ENCMENU+0x200]={-- 副手1
		{ENC, "攻强+110", 3827, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 800000 },
		{ENC, "法强+81", 3854, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 800000 },
		{ENC, "命中+25，爆击+25", 3788, EQUIPMENT_SLOT_OFFHAND	, 0 , "是否对副手装备附魔？" , 800000 },
		{ENC, "防御+20", 1952, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 800000 },
		{ENC, "盾牌格挡+15", 2655, EQUIPMENT_SLOT_OFFHAND		, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "韧性+12", 3229, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "格挡值+36", 2653, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "强效护盾",  2720 , EQUIPMENT_SLOT_OFFHAND		, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "破冰武器",  3239, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 500000 },
		{ENC, "作战专家",  2675, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 500000 },
		{ENC, "生命偷取",  1898, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 500000 },
		{MENU, "下一页", ENCMENU+0x1200,GOSSIP_ICON_BATTLE},
	},	
	[ENCMENU+0x1200]={-- 副手2
		{ENC, "生命护卫",  3241, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 800000 },
		{ENC, "巨人杀手",  3251, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 800000 },
		{ENC, "邪恶武器",  1899, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 5000000 },
		{ENC, "屠魔"    ,   912, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },	
		{ENC, "狂暴"    ,  3789, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 800000 },
		{ENC, "斩杀"    ,  3225, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 800000 },
		{ENC, "猫鼬"    ,  2673, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 800000 },
		{ENC, "黑魔法"  ,  3790, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 800000 },
		{ENC, "精金神铁武器链", 3223, EQUIPMENT_SLOT_OFFHAND	, 0 , "是否对副手装备附魔？" , 800000 },--缴械时间-50%,招架+15
		{ENC, "泰坦神铁武器链", 3731, EQUIPMENT_SLOT_OFFHAND	, 0 , "是否对副手装备附魔？" , 800000 },--缴械时间-50%,命中+28
		{ENC, "泰坦神铁盾刺 [70级]", 3748, EQUIPMENT_SLOT_OFFHAND, 0 , "是否对副手装备附魔？" , 800000 },--格挡反伤45-67
		{MENU, "下一页", ENCMENU+0x2200,GOSSIP_ICON_BATTLE},
	},
	[ENCMENU+0x2200]={-- 副手3
		{ENC, "毒皮毒药",  1003, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "速效药膏",  3769, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "致命药膏",  3771, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "致伤药膏",  3773, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "麻醉药膏",  3774, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "火舌武器",  3781, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "冰封武器",  3784, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "风怒武器",  3787, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "火焰石"  ,  3614, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "法术石"  ,  3620, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{MENU, "下一页", ENCMENU+0x3200,GOSSIP_ICON_BATTLE},
	},
	[ENCMENU+0x3200]={-- 副手4
		{ENC, "死亡霜冻",  3273, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 500000 },
		{ENC, "吸血 [75级]",  3870, EQUIPMENT_SLOT_OFFHAND		, 0 , "是否对副手装备附魔？" , 500000 },
		{ENC, "利刃防护 [75级]", 3869, EQUIPMENT_SLOT_OFFHAND	, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "灼热武器",   803, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "冰冷武器",  1894, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "暗影之油", 25, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "冰霜之油", 26, EQUIPMENT_SLOT_OFFHAND			, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "冰霜符文武器", 3322, EQUIPMENT_SLOT_OFFHAND		, 0 , "是否对副手装备附魔？" , 300000 },
		{ENC, "清除副手附魔",-1,EQUIPMENT_SLOT_OFFHAND},
	},
	[ENCMENU+0x300]={-- 远程
		{ENC, "攻强+110", 3827, EQUIPMENT_SLOT_RANGED			, 0 , "是否对装备附魔？" , 1000000 },
		{ENC, "法强+81", 3854, EQUIPMENT_SLOT_RANGED			, 0 , "是否对装备附魔？" , 1000000 },
		{ENC, "命中+25，爆击+25", 3788, EQUIPMENT_SLOT_RANGED	, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "远程爆击+40 [70级]", 3608, EQUIPMENT_SLOT_RANGED	, 0 , "是否对装备附魔？" , 1000000 },
		{ENC, "耐力+50",  3851, EQUIPMENT_SLOT_RANGED			, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "破冰武器",  3239, EQUIPMENT_SLOT_RANGED			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "邪恶武器",  1899, EQUIPMENT_SLOT_RANGED			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "死亡霜冻",  3273, EQUIPMENT_SLOT_RANGED			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "作战专家",  2675, EQUIPMENT_SLOT_RANGED			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "速效药膏",  3769, EQUIPMENT_SLOT_RANGED			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "致命药膏",  3771, EQUIPMENT_SLOT_RANGED			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "致伤药膏",  3773, EQUIPMENT_SLOT_RANGED			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "麻醉药膏",  3774, EQUIPMENT_SLOT_RANGED			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "冰封武器",  3784, EQUIPMENT_SLOT_RANGED			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "清除远程武器附魔",-1,EQUIPMENT_SLOT_RANGED},
	},
	[ENCMENU+0x10] = { -- 帽子
		{ENC, "全属性+10", 3832, EQUIPMENT_SLOT_HEAD			, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "生命+275", 3297, EQUIPMENT_SLOT_HEAD				, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "耐力+30，冰抗+25 [80级]", 3812, EQUIPMENT_SLOT_HEAD, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "耐力+37，防御+20 [80级]", 3818, EQUIPMENT_SLOT_HEAD, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "耐力+30，韧性+25 [80级]", 3842, EQUIPMENT_SLOT_HEAD, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "攻强+50，爆击+20 [80级]", 3817, EQUIPMENT_SLOT_HEAD, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "攻强+50，韧性+20 [80级]", 3795, EQUIPMENT_SLOT_HEAD, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "法强+30，爆击+20 [80级]", 3820, EQUIPMENT_SLOT_HEAD, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "法强+29，韧性+20 [80级]", 3797, EQUIPMENT_SLOT_HEAD, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "法强+30，法力回复+10 [80级]", 3819, EQUIPMENT_SLOT_HEAD, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "清除头盔附魔",-1,EQUIPMENT_SLOT_HEAD},
	},
	[ENCMENU+0x20] = { -- 项链
		{ENC, "全属性+10", 3832, EQUIPMENT_SLOT_NECK			, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "生命+275", 3297, EQUIPMENT_SLOT_NECK				, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "生命回复+10", 2438, EQUIPMENT_SLOT_NECK			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "法力回复+8", 2381, EQUIPMENT_SLOT_NECK			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "韧性+20", 3245, EQUIPMENT_SLOT_NECK				, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "防御+22", 1953, EQUIPMENT_SLOT_NECK				, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "清除项链附魔",-1,EQUIPMENT_SLOT_NECK	},
	},
	[ENCMENU+0x30] = { -- 肩部
		{ENC, "全属性+10", 3832, EQUIPMENT_SLOT_SHOULDERS		, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "攻强+50", 3845, EQUIPMENT_SLOT_SHOULDERS			, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "法强+30", 2332, EQUIPMENT_SLOT_SHOULDERS			, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "耐力+40", 3850, EQUIPMENT_SLOT_SHOULDERS			, 0 , "是否对装备附魔？" , 800000 },
		-- {ENC, "攻强+120,爆击+15 [铭文400]", 3835, EQUIPMENT_SLOT_SHOULDERS, 0 , "是否对装备附魔？" , 1000000 },
		-- {ENC, "法强+70 ,回蓝+8  [铭文400]", 3836, EQUIPMENT_SLOT_SHOULDERS, 0 , "是否对装备附魔？" , 1000000 },
		-- {ENC, "躲闪+60 ,防御+15 [铭文400]", 3837, EQUIPMENT_SLOT_SHOULDERS, 0 , "是否对装备附魔？" , 1000000 },
		-- {ENC, "法强+70 ,爆击+15 [铭文400]", 3838, EQUIPMENT_SLOT_SHOULDERS, 0 , "是否对装备附魔？" , 1000000 },
		{ENC, "清除肩甲附魔",-1,EQUIPMENT_SLOT_SHOULDERS},
	},
	[ENCMENU+0x40] = { -- 背部
		{ENC, "强化潜行，敏捷+10", 3256, EQUIPMENT_SLOT_BACK	, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "精神+10，威胁-2%", 3296, EQUIPMENT_SLOT_BACK		, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "防御+16", 1951, EQUIPMENT_SLOT_BACK				, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "急速+23", 3831, EQUIPMENT_SLOT_BACK				, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "护甲+225", 3294, EQUIPMENT_SLOT_BACK				, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "敏捷+22", 1099, EQUIPMENT_SLOT_BACK				, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "攻强+50", 3845, EQUIPMENT_SLOT_BACK				, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "法术穿透+35", 3243, EQUIPMENT_SLOT_BACK			, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "全属性+10", 3832, EQUIPMENT_SLOT_BACK			, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "法强+50,精神+20 [65级]", 3872, EQUIPMENT_SLOT_BACK, 0 , "是否对装备附魔？" , 1000000 },
		{ENC, "法强+50,耐力+30 [65级]", 3873, EQUIPMENT_SLOT_BACK, 0 , "是否对装备附魔？" , 1000000 },
		-- {ENC, "剑刃刺绣 [裁缝400]", 3730, EQUIPMENT_SLOT_BACK	, 0 , "是否对装备附魔？" , 1000000 },--一定几率提升400攻强15秒
		-- {ENC, "黑光刺绣 [裁缝400]", 3728, EQUIPMENT_SLOT_BACK	, 0 , "是否对装备附魔？" , 1000000 },--一定几率回复400法力值
		-- {ENC, "亮纹刺绣 [裁缝400]", 3722, EQUIPMENT_SLOT_BACK	, 0 , "是否对装备附魔？" , 1000000 },--一定几率提升295法强15秒
		-- {ENC, "高弹力衬垫 [工程350]", 3605, EQUIPMENT_SLOT_BACK	, 0 , "是否对装备附魔？" , 1000000 },--敏捷+23,降落伞
		{ENC, "清除披风附魔",-1,EQUIPMENT_SLOT_BACK},
	},
	[ENCMENU+0x50] = { -- 胸甲
		{ENC, "结界符文", 2791, EQUIPMENT_SLOT_CHEST			, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "所有属性+10", 3832, EQUIPMENT_SLOT_CHEST			, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "生命+275", 3297, EQUIPMENT_SLOT_CHEST			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "法力+250", 3233, EQUIPMENT_SLOT_CHEST			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "生命回复+10", 2438, EQUIPMENT_SLOT_CHEST			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "法力回复+8", 2381, EQUIPMENT_SLOT_CHEST			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "韧性+20", 3245, EQUIPMENT_SLOT_CHEST				, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "防御+22", 1953, EQUIPMENT_SLOT_CHEST				, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "清除胸甲附魔",-1,EQUIPMENT_SLOT_CHEST},
	},
	-- [ENCMENU+0x60] = { -- 衬衣
	-- 	{ENC, "所有属性+10", 3832, EQUIPMENT_SLOT_BODY			, 0 , "是否对装备附魔？" , 800000 },
	-- 	{ENC, "生命+275", 3297, EQUIPMENT_SLOT_BODY				, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "法力+250", 3233, EQUIPMENT_SLOT_BODY				, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "生命回复+10", 2438, EQUIPMENT_SLOT_BODY			, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "法力回复+8", 2381, EQUIPMENT_SLOT_BODY			, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "韧性+20", 3245, EQUIPMENT_SLOT_BODY				, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "防御+22", 1953, EQUIPMENT_SLOT_BODY				, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "清除衬衣附魔",-1,EQUIPMENT_SLOT_BODY},
	-- },
	-- [ENCMENU+0x70] = { -- 战袍
	-- 	{ENC, "所有属性+10", 3832, EQUIPMENT_SLOT_TABARD		, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "生命+275", 3297, EQUIPMENT_SLOT_TABARD			, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "法力+250", 3233, EQUIPMENT_SLOT_TABARD			, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "生命回复+10", 2438, EQUIPMENT_SLOT_TABARD		, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "法力回复+8", 2381, EQUIPMENT_SLOT_TABARD			, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "韧性+20", 3245, EQUIPMENT_SLOT_TABARD			, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "防御+22", 1953, EQUIPMENT_SLOT_TABARD			, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "清除战袍附魔",-1,EQUIPMENT_SLOT_TABARD},
	-- },
	[ENCMENU+0x80] = { -- 护腕
		{ENC, "耐力+40", 3850, EQUIPMENT_SLOT_WRISTS			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "法强+30", 2332, EQUIPMENT_SLOT_WRISTS			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "攻强+50", 3845, EQUIPMENT_SLOT_WRISTS			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "精准等级+15", 3231, EQUIPMENT_SLOT_WRISTS		, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "全属性+10", 3832, EQUIPMENT_SLOT_WRISTS			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "精神+18", 1147, EQUIPMENT_SLOT_WRISTS			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "智力+16", 1119, EQUIPMENT_SLOT_WRISTS			, 0 , "是否对装备附魔？" , 300000 },
--		{ENC, "攻强+130 [制皮400]", 3756, EQUIPMENT_SLOT_WRISTS	, 0 , "是否对装备附魔？" , 300000 },
--		{ENC, "法强+76  [制皮400]", 3758, EQUIPMENT_SLOT_WRISTS	, 0 , "是否对装备附魔？" , 300000 },
--		{ENC, "耐力+102 [制皮400]", 3757, EQUIPMENT_SLOT_WRISTS	},
		{ENC, "清除护腕附魔",-1,EQUIPMENT_SLOT_WRISTS},
	},
	[ENCMENU+0x90] = { -- 手套
		{ENC, "爆击+16", 3249, EQUIPMENT_SLOT_HANDS				, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "威胁+2%，招架等级+10", 3253, EQUIPMENT_SLOT_HANDS	, 0 , "是否对装备附魔？" ,500000 },
		{ENC, "攻强+50", 3845, EQUIPMENT_SLOT_HANDS				, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "法强+28", 3246, EQUIPMENT_SLOT_HANDS				, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "增加敏捷+20", 3222, EQUIPMENT_SLOT_HANDS			, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "命中等级+20", 3234, EQUIPMENT_SLOT_HANDS			, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "精准等级+15", 3231, EQUIPMENT_SLOT_HANDS			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "采集 [熟练度+5]", 3238, EQUIPMENT_SLOT_HANDS		, 0 , "是否对装备附魔？" , 300000 },
		-- {ENC, "超级加速器 [工程400]", 3604, EQUIPMENT_SLOT_HANDS, 0 , "是否对装备附魔？" , 500000 },
		-- {ENC, "手部火箭发射器 [工程400]", 3603, EQUIPMENT_SLOT_HANDS, 0 , "是否对装备附魔？" , 3500000 },
		{ENC, "清除手套附魔",-1,EQUIPMENT_SLOT_HANDS},
	},
	[ENCMENU+0xa0] = { -- 腰部
		{ENC, "全属性+10", 3832, EQUIPMENT_SLOT_WAIST			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "生命+275", 3297, EQUIPMENT_SLOT_WAIST			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "法力回复+8", 2381, EQUIPMENT_SLOT_WAIST			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "韧性+20", 3245, EQUIPMENT_SLOT_WAIST				, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "防御+22", 1953, EQUIPMENT_SLOT_WAIST				, 0 , "是否对装备附魔？" , 300000 },
		-- {ENC, "钴质破片炸弹 [工程350]", 3601, EQUIPMENT_SLOT_WAIST, 0 , "是否对装备附魔？" , 300000 },
		-- {ENC, "电磁脉冲发生器 [工程350]", 3599, EQUIPMENT_SLOT_WAIST, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "清除腰带附魔",-1,EQUIPMENT_SLOT_WAIST},
	},
	[ENCMENU+0xb0] = { -- 腿部
		{ENC, "法强+30", 2332, EQUIPMENT_SLOT_LEGS				, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "攻强+50", 3845, EQUIPMENT_SLOT_LEGS				, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "全属性+10", 3832, EQUIPMENT_SLOT_LEGS			, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "耐力+55,敏捷+22 [65级]", 3328, EQUIPMENT_SLOT_LEGS, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "攻强+75,爆击+22 [65级]", 3328, EQUIPMENT_SLOT_LEGS, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "法强+50,精神+20 [65级]", 3872, EQUIPMENT_SLOT_LEGS, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "法强+50,耐力+30 [65级]", 3873, EQUIPMENT_SLOT_LEGS, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "耐力+28,韧性+40 [80级]", 3853, EQUIPMENT_SLOT_LEGS, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "清除裤子附魔",-1,EQUIPMENT_SLOT_LEGS},
	},     
	[ENCMENU+0xc0] = { -- 脚部
		{ENC, "鞋垫", 2795, EQUIPMENT_SLOT_FEET					, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "攻强+50", 3845, EQUIPMENT_SLOT_FEET				, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "耐力+15，移动速度", 3232, EQUIPMENT_SLOT_FEET	, 0 , "是否对装备附魔？" , 300000 },
		{ENC, "敏捷+16", 983, EQUIPMENT_SLOT_FEET				, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "精神+18", 1147, EQUIPMENT_SLOT_FEET				, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "命中+12，爆击+12", 3826, EQUIPMENT_SLOT_FEET		, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "耐力+22", 1075, EQUIPMENT_SLOT_FEET				, 0 , "是否对装备附魔？" , 500000 },
--		{ENC, "硝化甘油推进器 [工程400]", 3606, EQUIPMENT_SLOT_FEET, 0 , "是否对装备附魔？" , 800000 },
		{ENC, "清除靴子附魔",-1,EQUIPMENT_SLOT_FEET},
	},
	[ENCMENU+0xd0]={-- 戒指
		{ENC, "① 法力回复+8", 2381, EQUIPMENT_SLOT_FINGER1		, 0 , "是否对戒指一附魔？" , 300000 },
		{ENC, "① 生命回复+10", 2438, EQUIPMENT_SLOT_FINGER1		, 0 , "是否对戒指一附魔？" , 300000 },
		-- {ENC, "① 法强+23 [附魔400]", 3840, EQUIPMENT_SLOT_FINGER1	, 0 , "是否对装备附魔？" , 500000 },
		-- {ENC, "① 攻强+40 [附魔400]", 3839, EQUIPMENT_SLOT_FINGER1	, 0 , "是否对装备附魔？" , 500000 },
		-- {ENC, "① 耐力+30 [附魔400]", 3791, EQUIPMENT_SLOT_FINGER1	, 0 , "是否对装备附魔？" , 500000 },
		-- {ENC, "① 全属性+4 [附魔350]", 2931, EQUIPMENT_SLOT_FINGER1	, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "② 法力回复+8", 2381, EQUIPMENT_SLOT_FINGER2		, 0 , "是否对戒指二附魔？" , 300000 },
		{ENC, "② 生命回复+10", 2438, EQUIPMENT_SLOT_FINGER2		, 0 , "是否对戒指二装备附魔？" , 300000 },
		-- {ENC, "② 法强+23 [附魔400]", 3840, EQUIPMENT_SLOT_FINGER2	, 0 , "是否对装备附魔？" , 500000 },
		-- {ENC, "② 攻强+40 [附魔400]", 3839, EQUIPMENT_SLOT_FINGER2	, 0 , "是否对装备附魔？" , 500000 },
		-- {ENC, "② 耐力+30 [附魔400]", 3791, EQUIPMENT_SLOT_FINGER2	, 0 , "是否对装备附魔？" , 500000 },
		-- {ENC, "② 全属性+4 [附魔350]", 2931, EQUIPMENT_SLOT_FINGER2	, 0 , "是否对装备附魔？" , 500000 },
		{ENC, "清除戒指①附魔",-1,EQUIPMENT_SLOT_FINGER1},
		{ENC, "清除戒指②附魔",-1,EQUIPMENT_SLOT_FINGER2},
	},
	-- [ENCMENU+0xe0]={-- 饰品
	-- 	{ENC, "① 法力回复+8", 2381, EQUIPMENT_SLOT_TRINKET1		, 0 , "是否对饰品一附魔？" , 300000 },
	-- 	{ENC, "① 生命回复+10", 2438, EQUIPMENT_SLOT_TRINKET1	, 0 , "是否对饰品一附魔？" , 300000 },
	-- 	{ENC, "① 法术穿透+35", 3243, EQUIPMENT_SLOT_TRINKET1	, 0 , "是否对饰品一附魔？" , 300000 },
	-- 	{ENC, "① 急速+23", 3831, EQUIPMENT_SLOT_TRINKET1		, 0 , "是否对饰品一附魔？" , 300000 },
	-- 	{ENC, "① 耐力+30 [附魔400]", 3791, EQUIPMENT_SLOT_TRINKET1	, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "① 全属性+4 [附魔350]", 2931, EQUIPMENT_SLOT_TRINKET1	, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "② 法力回复+8", 2381, EQUIPMENT_SLOT_TRINKET2		, 0 , "是否对饰品二附魔？" , 300000 },
	-- 	{ENC, "② 生命回复+10", 2438, EQUIPMENT_SLOT_TRINKET2	, 0 , "是否对饰品二附魔？" , 300000 },
	-- 	{ENC, "② 法术穿透+35", 3243, EQUIPMENT_SLOT_TRINKET2	, 0 , "是否对饰品二附魔？" , 300000 },
	-- 	{ENC, "② 急速+23", 3831, EQUIPMENT_SLOT_TRINKET2		, 0 , "是否对饰品二附魔？" , 300000 },
	-- 	{ENC, "② 耐力+30 [附魔400]", 3791, EQUIPMENT_SLOT_TRINKET2	, 0 , "是否对装备附魔？" , 300000 },
	-- 	{ENC, "② 全属性+4 [附魔350]", 2931, EQUIPMENT_SLOT_TRINKET2	, 0 , "是否对装备附魔？" , 300000 },
...
local function Enchanting(player, EncSpell, Eid, money) --附魔 (玩家,附魔效果,附魔位置)
	...
	if (Nowitem and Eid )  then--存在物品
		...
		local WName = Nowitem:GetItemLink(4)--物品链接
	...
	for k, v in pairs(Rows) do 
		...
		elseif(mtype==FUNC or mtype==ENC)then
			...
			if((code==true or code ==false))then
				...
				player:GossipMenuAddItem(icon, text, money, intid, false,msg, money )
			end
	...
	if(rowid== 0)then
		...
		if(v)then						--如果找到菜单项
			...
			elseif(mtype==ENC)then
				...
				ret = Enchanting(player, spellId, equipId, 0)
				if (ret == false) then
					player:ModifyMoney(sender)--返还
				end
